...
number makes this impossible. For a feasable method to compute the number, see
...
; and subboards of N fields. Allowed are elements n, 1≤n≤N.
...
;;   (define (print-board) (board-fmt board))
